...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tight-water-5e18
```

A live public deployment of this template is available at [https://tight-water-5e18.templates.workers.dev](https://tight-water-5e18.templates.workers.dev)
